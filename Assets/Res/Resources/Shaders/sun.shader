...
Shader "lcl/shaderToy/sun" { 
    Properties{
        ...
        _orange ("Orange", Vector) = (0.8, 0.65, 0.3, 1)
        _orangeRed ("OrangeRed", Vector) = (0.8, 0.35, 0.1, 1)
    }
    ...
    vec4 main(vec2 fragCoord) {
        ...
        vec3 orange         = _orange;//用Vector sun颜色即可控。且Vector比Color颜色“准确”,原因未知
        vec3 orangeRed      = _orangeRed;
    ...
    SubShader {    
        Pass {    
            ...
            #pragma fragmentoption ARB_precision_hint_fastest//ARB 负责OpenGl未来的独立联盟的扩展名
